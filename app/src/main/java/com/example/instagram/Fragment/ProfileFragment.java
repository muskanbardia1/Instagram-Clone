...
public class ProfileFragment extends Fragment {
    ...
    private void userInfo(){
        ...
        StorageReference firebaseStorage = FirebaseStorage.getInstance().getReference().child("placeholder");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String url="https://firebasestorage.googleapis.com/v0/b/instagram-210df.appspot.com/o/placeholder.jpg?alt=media&token=ffe3dda1-2f4a-46c3-8247-5b1aafb48739";//Retrieved url as mentioned above
                    User user = snapshot.getValue(User.class);
                    Glide.with(getContext()).load(url).into(image_profile);
